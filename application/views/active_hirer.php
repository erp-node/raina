             ...
             <div class="page-title">
              <div class="h2 title_left" id="in_voice">
				...
				<li><a href="<?php echo base_url('Admin/index');?>">HOME</a></li>
                  <li><a href="<?php echo base_url('Admin/active_hirer');?>">Active Hirers List &nbsp;&nbsp;</a></li>
                    ...
                    <table class="table table-striped" id="customers_list">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td></td>
                          <td></td>
                          <td><a href="#">  <button  class="btn btn-primary" >Active</button></a>&nbsp; <a href="#">  <button  class="btn btn-warning" >In Active</button></a></td>
                        </tr>
